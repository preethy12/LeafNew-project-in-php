...
tblplantrequests
 ...
 where  (tblplantrequests.requestNumber like '%$sdata%' || tblplantrequests.fullName  like '%$sdata%' || tblplantrequests.mobileNumber like '%$sdata%') ");
$cnt=1;
