...
<!DOCTYPE html>
<head>
<title>leaf Now | dashboard </title>
...
?>
					<div class="col-md-8 market-update-left">
					<h4><a href="manage-donor-details.php" style="color: white">Total Donors</a></h4>
			...
			<div class="col-md-3 market-update-gd">
				<div class="market-update-block clr-block-2">
					<div class="col-md-4 market-update-right">
						<i class="icon-food fa fa-tree"> </i>
					</div>
					<?php 
					$query=mysqli_query($con,"Select tblplant.DonorID,tbldonor.ID from  tblplant join tbldonor on  tbldonor.ID=tblplant.DonorID");
$totallistedplant=mysqli_num_rows($query);
?>
					<div class="col-md-8 market-update-left">
					<h4><a href="all-listed-plant.php" style="color: white">Total Listed Items</a></h4>
						<h3><?php echo $totallistedplant;?></h3>
	...
	<?php 
					$query=mysqli_query($con,"select tblplantrequests.id from tblplantrequests
...
?>
			...
			<?php 
					$query=mysqli_query($con,"select tblplantrequests.id from tblplantrequests
 join tblplant  on tblplant.ID=tblplantrequests.plantId 
 where   (tblplantrequests.status is null || tblplantrequests.status='')");
...
?>
			...
			<?php 
					$query=mysqli_query($con,"select tblplantrequests.id from tblplantrequests
 join tblplant on tblplant.ID=tblplantrequests.plantId 
 where  (tblplantrequests.status='Request Rejected')");
...
?>
			...
			<?php 
					$query=mysqli_query($con,"select tblplantrequests.id from tblplantrequests
 join tblplant  on tblplant.ID=tblplantrequests.plantId 
 where (tblplantrequests.status='Request Completed')");
...
?>
			<div class="col-md-4 market-update-gd" style="margin-top:1%;">
				<div class="market-update-block clr-block-1">
					...
					<div class="col-md-8 market-update-left">
					<a href="completed-requests.php"><h4>Request Completed </h4></a>
