...
<!DOCTYPE html>
<head>
<title>leaf Now|| B/w Dates Report Details</title>
...
?>
        ...
        <?php
$ret=mysqli_query($con,"select tblplant.ID,tblplant.plantId,tblplant.ContactPerson,tblplant.CPMobNumber,tblplant.CreationDate,tblplant.plantItems,tbldonor.FullName,tbldonor.MobileNumber from  tblplant join tbldonor on tblplant.DonorID=tbldonor.ID where date(tblplant.CreationDate) between '$fdate' and '$tdate'");
$cnt=1;
