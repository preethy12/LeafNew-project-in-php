...
if (strlen($_SESSION['pgasoid']==1)) {
    ...
    if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update  tblpplantrequests set status='$status',donorRemark='$donormsg' where id='$frid'");
    if ($query) {
...
<td colspan="4" style="font-size:20px;color:blue">
 View Order details Details of #<?php  echo $row['requestNumber'];?></td></tr>    
  <tr>
    <th>Register By </th>
  ...
  <tr>
   ...
   <select name="status" class="form-control wd-450" required="true" >
    <option value="">Select</option>
     <option value="Request Completed"> Order Completed</option>
     <option value="Request Rejected">Order Rejected</option>
   </select></td>
  </tr>
  <tr>
    <th>Remark :</th>
