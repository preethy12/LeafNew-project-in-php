...
$ret1=mysqli_query($con,"select tblplantrequests.id,fullName,requestNumber from tblplantrequests
 join tblplant  on tblplant.ID=tblplantrequests.plantId 
 where tblplant.DonorID='$did' and (tblplantrequests.status is null || tblplantrequests.status='')");
