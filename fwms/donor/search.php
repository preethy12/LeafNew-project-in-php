...
<!DOCTYPE html>
<head>
<title>LEAF NOW||Search Plant Listed Details </title>
...
tblplantrequests
 ...
 where (tblplant.DonorID='$donarid') and (tblplantrequests.requestNumber like '%$sdata%' || tblplantrequests.fullName  like '%$sdata%' || tblplantrequests.mobileNumber like '%$sdata%') ");
$cnt=1;
