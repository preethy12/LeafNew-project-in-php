...
$donarid=$_SESSION['pgasoid'];
					$query=mysqli_query($con,"Select * from  tblplant where DonorID='$donarid'");
$fcounts=mysqli_num_rows($query);
?>
					 <div class="col-md-8 market-update-left">
					 <a href="manage-plant-details.php"><h4>Total Listed Plants</h4></a>
 ...
 where tblplant.DonorID='$donarid' and (tblplantrequests.status='Request Completed')");
...
?>
			<div class="col-md-4 market-update-gd">
				<div class="market-update-block clr-block-1">
					...
					<div class="col-md-8 market-update-left">
					<a href="completed-requests.php" style="color:#fff;"><h5> Request Completed </h5></a>
...
?>
			...
			<?php 
					$query=mysqli_query($con,"select tblplantrequests.id from tblplantrequests
 join tblplant  on tblplant.ID=tblplantrequests.plantId 
 where tblplant.DonorID='$donarid' ");
...
?>
			...
			<?php 
					$query=mysqli_query($con,"select tblplantrequests.id from tblplantrequests
 join tblplant  on tblplant.ID=tblplantrequests.plantId 
 where tblplant.DonorID='$donarid' and (tblplantrequests.status is null || tblplantrequests.status='')");
