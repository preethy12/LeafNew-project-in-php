...
<!DOCTYPE html>
<head>
<title>leaf new|| New Plant Requests</title>
...
tblplantrequests
 join tblplant  on tblplant.ID=tblplantrequests.plantId where tblplant.DonorID='$donarid' and (tblplantrequests.status is null || tblplantrequests.status='')");
$cnt=1;
