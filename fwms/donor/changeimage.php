...
$foodpic=md5($pgpic).$extension;
    ...
    $query=mysqli_query($con, "update tableplant set Image='$foodpic' where ID='$cid'");
    if ($query) {
  
      echo "<script>alert('Donating plant Image has been Update');</script>";
  }
  else
    {
